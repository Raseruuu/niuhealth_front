...
function PatientRegistration() {
  ...
  return (
    ...
    {/* <!-- end page title end breadcrumb --> */}
        ...
        <div className="col-lg-6">
          ...
          <label for="example-text-input" className="col-form-label text-right">Phone Number</label>
  ...
  <div className="form-group row">
                                <div className="col-md-12">
        <label for="example-text-input" className="col-form-label text-right">Address</label></div>
                                <div className="col-md-12">
                                    <input className="form-control" type="text" value="" id="example-text-input" />
                                </div>
                            </div>
      <div className="form-group row">
          ...
          <label for="example-text-input" className="col-form-label text-right">Country</label>
          <select className="form-control">
                                ...
                                <div className="col-md-6">
          <label for="example-text-input" className="col-form-label text-right">City</label>
                                    <select className="form-control">
    ...
    <div className="form-group row">
                                <div className="col-md-12">
          <label for="example-text-input" className="col-form-label text-right">
Subscription may cost more for patients not residing in Hawaii. <a href="">Know more</a></label>
  ...
  <div className="form-group row">
        <div className="col-md-6">
            <label for="example-date-input" className="">Date of Birth</label>
